    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> UpdateStatus([FromBody] OrderViewModel order)
        {
            ...
            if (order.Status == "Preparing" || order.Status == "Ready"){
                ...
                await sendInstuctions("https://mc-connect-manager.smcs.io/api/v1/update-image",orderInDb.MctId);
            }

            return Json(new { success = true, message = "Order status updated successfully." });
        }

        private async Task sendInstuctions(string endpoint, string id)
        {
            ...
            {
                device_ids = new[] { id }, // The id from NotificationViewModel as device_id
                ...
                content = instructionsBase64 // Set the Base64-encoded image content dynamically
            };
